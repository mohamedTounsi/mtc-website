  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto bg-gradient-to-b from-[#131318] to-[#0d0d10] rounded-2xl border border-purple-800/50 shadow-lg shadow-purple-900/30 backdrop-blur-sm">
