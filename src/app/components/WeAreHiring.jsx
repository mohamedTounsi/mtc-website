...
const WeAreHiring = () => {
  ...
  const handleJoinUs = () => {
    router.push("/hire-form"); // <-- navigate to /hire-form
  };
    ...
    >
      ...
      <div className="relative z-10 py-4 border-b border-white/10">
        <Marquee
          gradient={false}
          speed={
            window.innerWidth < 480 ? 80 : window.innerWidth < 768 ? 50 : 30
          }
          pauseOnHover={false}
        >
          <span className="text-lg font-light text-white/70 mx-16">
            ✦ Join Our Team
          </span>
          <span className="text-lg font-light text-white/70 mx-16">
            ✦ Innovate Together
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-20">
        <div className="text-center mb-12 max-w-5xl">
          ...
          <button
            onClick={handleJoinUs} // <-- using router.push now
