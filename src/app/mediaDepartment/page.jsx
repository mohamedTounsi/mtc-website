...
import { Camera, Sparkles, Video, Film, Palette, Play } from "lucide-react";
...
export default function DepartmentPage() {
  const teamMembers = [
    ...
    },
    {
      ...
      role: "Video Editor",
      image: "/ayoub.jpeg",
      linktree: "https://linktr.ee/ayoub.fourati",
  ...
  return (
    <div className="relative pt-[63px] md:pt-0 min-h-screen overflow-hidden bg-gradient-to-br from-black via-gray-950 to-purple-950/20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-fuchsia-600/10 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-pink-600/5 rounded-full blur-2xl animate-pulse delay-500"></div>
        ...
        <div className="absolute bottom-40 right-20 opacity-5 animate-float-delayed">
          <Video className="w-12 h-12 text-violet-500" />
        </div>
        <div className="absolute top-1/3 right-10 opacity-5 animate-float">
          <Palette className="w-14 h-14 text-pink-500" />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-white via-fuchsia-200 to-violet-200 bg-clip-text text-transparent mb-6 tracking-tight">
            MEDIA TEAM
          </h1>
          ...
          <div className="relative w-32 sm:w-48 h-1 mx-auto mb-8 rounded-full overflow-hidden bg-gradient-to-r from-transparent via-purple-500/30 to-transparent">
            <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-400 via-purple-400 to-violet-400 animate-shimmer"></div>
          </div>

          <p className="text-gray-400 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto font-light">
            The creative force that shapes our visual identity. From stunning
            designs and engaging content to impactful storytelling, our media
            team brings ideas to life and ensures our message connects with the
            world.
          </p>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl rounded-3xl border border-white/10 group-hover:border-purple-400/30 transition-all duration-500 overflow-hidden shadow-2xl">
                ...
                <div className="p-8 pt-6 text-center space-y-4">
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 group-hover:bg-gradient-to-r group-hover:from-fuchsia-200 group-hover:to-violet-200 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                      {member.name}
                    </h3>
        ...
        <div className="mt-16 lg:mt-20 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/5 backdrop-blur-xl rounded-full border border-white/10 hover:border-purple-400/30 transition-all duration-300">
            ...
            <span className="text-gray-400 text-sm sm:text-base font-medium">
              Designing experiences, one interaction at a time
            </span>
            <div
