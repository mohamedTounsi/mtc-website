      ...
      <div className="max-w-7xl mx-auto relative z-10 p-8">
        <div className="text-center mb-16 ">
          <div className="relative mb-6">
            <h1 className="text-[5.5px] md:text-[18px] py-4 md:py-6 font-dreams bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent mb-4 tracking-tight">
              MEDIA TEAM
            </h1>
