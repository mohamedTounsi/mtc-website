    ...
    >
      ...
      >
        <div className="relative">
          ...
          <div className="absolute -bottom-2 left-0 lg:left-0 w-24 h-1 bg-gradient-to-r from-purple-600 to-purple-400 rounded-full mx-auto lg:mx-0"></div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
        {departments.map((dept, index) => (
          <motion.div
            ...
            onClick={() => router.push(`/${dept.slug}`)} // 👈 add this
          >
            <div className="relative h-full p-8 rounded-2xl bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm border border-purple-500/20 hover:border-purple-400/40 transition-all duration-500 group-hover:transform group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-purple-500/10">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-purple-400 text-sm font-medium  group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1">
                    See Department
                  </span>
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-500/20 group-hover:bg-purple-500/30 transition-all duration-300">
                    <ArrowRight className="w-7 h-7 text-purple-400 transform  group-hover:text-purple-300 transition-all duration-300" />
                  </div>
                </div>

                <div className="mt-6 h-px bg-gradient-to-r from-purple-500/0 via-purple-500/50 to-purple-500/0 group-hover:from-purple-400/0 group-hover:via-purple-400/80 group-hover:to-purple-400/0 transition-all duration-500"></div>
              </div>
