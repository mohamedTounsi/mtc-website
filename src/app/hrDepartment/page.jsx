...
import { Users, Sparkles, Package, UserCheck, Briefcase } from "lucide-react";
  ...
  return (
    <div className="relative pt-[63px] md:pt-0 min-h-screen overflow-hidden bg-gradient-to-br from-black via-gray-950 to-purple-950/20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-10 opacity-5 animate-float">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent mb-6 tracking-tight">
            HR & LOGISTICS TEAM
          </h1>
          ...
          <p className="text-gray-400 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto font-light">
            Balancing people and operations, our HR & Logistics team recruits
            and nurtures talent while ensuring smooth coordination of resources
            and processes. They create a thriving workplace and keep everything
            running efficiently to drive success.
          </p>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl rounded-3xl border border-white/10 group-hover:border-purple-400/30 transition-all duration-500 overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-6 right-6 z-20">
                  <div
                    className={`flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r ${member.gradient} rounded-full border border-white/20 shadow-lg backdrop-blur-sm`}
                  >
                  ...
                  <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl group-hover:shadow-purple-500/20 transition-all duration-500">
                    ...
                    <div className="absolute bottom-4 left-4 z-20">
                      <a
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 backdrop-blur-xl border border-white/30 shadow-lg shadow-emerald-500/30 hover:shadow-emerald-400/50 hover:scale-105 transition-all duration-300 text-white text-xs sm:text-sm font-semibold"
                      >
                        <svg
                          className="w-4 h-4"
                          viewBox="0 0 24 24"
                ...
                <div className="p-6 pt-5 text-center space-y-3">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:bg-gradient-to-r group-hover:from-purple-200 group-hover:to-pink-200 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                      {member.name}
                    </h3>

                    <div className="relative w-16 h-1 mx-auto mb-3 rounded-full overflow-hidden bg-white/10">
                      <div
        ...
        <div className="mt-16 lg:mt-20 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/5 backdrop-blur-xl rounded-full border border-white/10 hover:border-purple-400/30 transition-all duration-300">
            ...
            <span className="text-gray-400 text-sm sm:text-base font-medium">
              Powering operations through people and logistics, one day at a
              time
            </span>
            <div
