...
export default function hero(){
    return (
        ...
        initial={{ opacity: 0}} 
        animate={{ opacity: 1}} 
        transition={{ duration: 2, transition:'easeOut',delay:0.2 }} 
      >
                <Glow1/>
                <Glow2/>
                <Glow3/>
        ...
        transition={{ duration: 0.8, transition:'easeOut',delay:1 }} 
      >
        ...
        initial={{ opacity: 0,y:50}} 
        animate={{ opacity: 1,y:0}} 
        transition={{ duration: 1, transition:'easeOut',delay:1.5 }} 
      >
            <div>
        ...
        initial={{ opacity: 0,y:50}} 
        animate={{ opacity: 1,y:0}} 
        transition={{ duration: 1.5, transition:'easeOut',delay:2.3 }} 
      >
